...
- [4 安全提示](#_4-%E5%AE%89%E5%85%A8%E6%8F%90%E7%A4%BA)
...
- [6 机械安装说明](#_6-%E6%9C%BA%E6%A2%B0%E5%AE%89%E8%A3%85%E8%AF%B4%E6%98%8E)
	...
	- [6.4 安装定子电机冷却装置](#_64-%E5%AE%89%E8%A3%85%E5%AE%9A%E5%AD%90%E7%94%B5%E6%9C%BA%E5%86%B7%E5%8D%B4%E8%A3%85%E7%BD%AE)
		- [6.4.1 串联定子电机冷却装置接线示意图](#_641-%E4%B8%B2%E8%81%94%E5%AE%9A%E5%AD%90%E7%94%B5%E6%9C%BA%E5%86%B7%E5%8D%B4%E8%A3%85%E7%BD%AE%E6%8E%A5%E7%BA%BF%E7%A4%BA%E6%84%8F%E5%9B%BE)
		- [6.4.2 并联定子电机冷却装置接线示意图](#_642-%E5%B9%B6%E8%81%94%E5%AE%9A%E5%AD%90%E7%94%B5%E6%9C%BA%E5%86%B7%E5%8D%B4%E8%A3%85%E7%BD%AE%E6%8E%A5%E7%BA%BF%E7%A4%BA%E6%84%8F%E5%9B%BE)
...
- 所有客户都必须采取一切必要的磁铁相关预防措施,以降低受伤风险。
- 减少受伤的危险。在任何情况下,B&R对 Planar 马达产品内的强磁铁造成的任何伤害或损坏概不负责。
- 6D产品不具有故障保护功能。机器制造商和自动化系统集成商机器制造商和自动化系统集成商最终有责任确保含有电机定子与动子托盘产品的机器或系统产品的机器或系统达到安全状态。
- 请勿让动子接触铁物体、强磁!!!

# 5 安装注意事项说明

1.6D每一块的方向必须相同，参考背面的坐标轴；
2.定子四角的其中一对中，有销钉孔位，尽量使用尺寸恰好的销钉固定；
...
5.供电线对侧为水冷管的预留位置；
6.供电线缆上有一个部分可以旋转，在拔线的时候需要旋转接线的端子头后拔出，**切勿暴力拆卸损伤定子**；
7.控制器接入定子的线需要在1号定子位置
...
- 可将节段安装在机器制造的安装台上，将节段的四个支脚固定在螺纹孔中。为使分段在安装台上精确定位，可在分段相对的两个支脚上开孔/槽，参见在安装板上组装分段的示例。
- 分段的两侧各有两个 M5 螺纹孔，用于在分段上直接安装辅助设备。
- 在安装节段或节段上的附加装置时，必须确保不超过节段技术细节中规定的最大扭矩。

> 分段的顶面由软铜制成，表面覆盖玻璃纤维。
> 必须遵守以下操作注意事项，以避免损坏分段：
> 请勿将段落放在顶面的边缘上。
> 请勿在分段表面放置任何重物！
> 切勿用工具敲击区段表面或边缘。
> 请勿将尖锐物品置于区段表面！
...
- 根据系统和应用要求，系统集成商可以串联或并联连接各段中的冷却通道。并联连接可以允许更高的流体流速和更低的冷却剂温度升高。下图显示了串联或并联连接的分段冷却系统示例。
- 两个冷却接头中的任何一个都可以用作入口或出口。

### 6.4.1 串联定子电机冷却装置接线示意图

![](FILES/004ACOPOS%206D常见物料与接线说明/image-20240330145612448.png)

### 6.4.2 并联定子电机冷却装置接线示意图

- 如果各段并联连接，系统集成商应在每个分支安装流量均衡阀，以均衡每个段的流速，并在每个段分支的出口安装止回阀
...
- 每两个相邻定子电机（Segement）之间铺设一条网线；必须遵守数据连接上的箭头方向。
