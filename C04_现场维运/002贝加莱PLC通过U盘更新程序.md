...
- <span style="background:#F0A7D8">2___</span>.选择Generate PIP incl. support of AR < 4.33 选项
    ...
    - 🧾 **AS4.12.5** 开始只有两个选项，选择直接到U盘的选项即可
    - ![](FILES/002贝加莱PLC通过U盘更新程序/image-20241106211827489.png)
...
> 此问题仅存在于AS4.3 ~ AS4.11版本，AS4.12只有两个选项，选择到U盘的即可。
